...
VLC_API int net_OpenDgram_ttl( vlc_object_t *p_this, const char *psz_bind, int i_bind, const char *psz_server, int i_server, int hlim, int proto ); 
                             //vlc_object_t *p_this, const char *psz_bind, int i_bind, const char *psz_server, int i_server, int proto
                             //vlc_object_t *p_this, const char *psz_bind, int i_bind, const char *psz_server, int i_server, int family, int hlim, int proto
//VLC_EXPORT( int, net_OpenDgram_ttl, ( vlc_object_t *p_this, const char *psz_bind, int i_bind, const char *psz_server, int i_server, int hlim, int proto ) );
                                    //vlc_object_t *p_this, const char *psz_bind, int i_bind, const char *psz_server, int i_server, int hlim, int proto
#define net_OpenDgram_ttl( a, b, c, d, e, h, g ) \
        net_OpenDgram_ttl(VLC_OBJECT(a), b, c, d, e, h, g)
#define net_OpenDgram( a, b, c, d, e, g ) \
        net_OpenDgram_ttl(a, b, c, d, e, -1, g)
