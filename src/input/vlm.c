 ...
 * vlm_ExecuteCommand:
 *****************************************************************************/
void vlm_GetCkpt( vlm_t *p_vlm, void ** data, unsigned long long *size){
    *data = (void*)&p_vlm->ckpt_pos;
    *size = sizeof(p_vlm->ckpt_pos);
}
...
static int vlm_ControlMediaInstanceStart( vlm_t *p_vlm, int64_t id, const char *psz_id, int i_input_index, const char *psz_vod_output, int64_t resume_pos )
{
    vlm_media_sys_t *p_media = vlm_ControlMediaGetById( p_vlm, id );
    ...
    if( asprintf( &psz_log, _("Media: %s"), p_media->cfg.psz_name ) != -1 )
    {
        ...
        if( p_instance->p_input )
        {
            ...
            if ( resume_pos >= 0 )
               var_SetTime(p_instance->p_input, "resume-time", resume_pos);
...
static int vlm_vaControlInternal( vlm_t *p_vlm, int i_query, va_list args )
{
    ...
    //  return vlm_ControlMediaInstanceStart( p_vlm, id, psz_id, i_int, NULL );
        ...
        return vlm_ControlMediaInstanceStart( p_vlm, id, psz_id, i_int, NULL, i_i64 );
    ...
    case VLM_START_MEDIA_VOD_INSTANCE:
        ...
        i_i64 = (int64_t)va_arg( args, int64_t );
        return vlm_ControlMediaInstanceStart( p_vlm, id, psz_id, i_int, psz_vod, i_i64 );
