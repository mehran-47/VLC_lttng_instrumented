 ...
 *
 * $Id: 77dcf579161134fe3a9fea00f5a6477f7cb9da1f $
 *
...
#undef net_OpenDgram_ttl
/*****************************************************************************
 * net_OpenDgram:
 *****************************************************************************
 * OpenDgram a datagram socket and return a handle
 *****************************************************************************/
//    net_OpenDgram_ttl( vlc_object_t *p_this, const char *psz_bind, int i_bind, 
  int net_OpenDgram_ttl( vlc_object_t *obj, const char *psz_bind, int i_bind,
                // const char *psz_server, int i_server, int hlim, int proto ); 
                   const char *psz_server, int i_server, int i_hlim, int protocol )
{
    ...
    for (struct addrinfo *ptr = loc; ptr != NULL; ptr = ptr->ai_next)
    {
        ...
        if( i_hlim >= 0 )
            net_SetMcastHopLimit( obj, fd, ptr->ai_family, i_hlim );
